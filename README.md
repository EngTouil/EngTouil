...
- **[Portfolio Website](https://github.com/EngTouil/Mohammed-Touil-Portfolio)** 🏗️ — Under active development. Built from scratch with plain HTML, CSS, and JavaScript — no frameworks, no build tools.
...
- 🎮 **Gamer** — My interest in system optimization started from wanting better performance in games.
- 🎬 **Video Editor** — Mid-level proficiency in DaVinci Resolve, mostly on technical and creative projects.
- 🏍️ Commuting to ISGA on my motorcycle daily.
